...
print(f"The shape {shape} has internal angles which measure {angle_sum} degrees.")
# print("The shape " + shape + " has external angles which measure " + str(external_angle_sum) + " degrees.")
print(f"The shape {shape} has external angles which measure {external_angle_sum} degrees.")
